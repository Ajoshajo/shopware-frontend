...
<template>
  <div class="bg-white">
    ...
    <div class="max-w-2xl mx-auto px-2 md:px-0 lg:max-w-full">
      <div class="mt-6">
        <div
          v-if="!loading"
          ref="productListElement"
          class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-8 content-center productListElement"
        >
          <SwProductCard
            ...
            class="p-4 rounded-lg transition-shadow duration-200 ease-in-out"
          />
        </div>
        <div
          v-if="loading"
