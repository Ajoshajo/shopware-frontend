...
import SwFilterPriceVue from "./SwFilterPrice.vue";
import SwFilterPropertiesVue from "./SwFilterProperties.vue";
import SwFilterRatingVue from "./SwFilterRating.vue";
import SwFilterShippingFreeVue from "./SwFilterShippingFree.vue";
