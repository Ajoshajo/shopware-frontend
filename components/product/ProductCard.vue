...
<template>
  <div
    class="sw-product-card group relative w-full inline-block max-w-sm bg-white border border-secondary-200 rounded-md shadow transform transition duration-300 hover:scale-101"
