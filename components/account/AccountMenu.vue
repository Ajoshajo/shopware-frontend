...
<template>
  <div class="md:w-auto min-w-140px flex justify-end items-center">
    <div class="my-account-area">
      <ClientOnly>
          <div
          v-show="!isLoggedIn"
            class="whitespace-nowrap bg-transparent text-xl font-medium h-full"
            data-testid="header-sign-in-link"
            @click="loginModalController.open"
          >
            <img src="~/assets/icons/user.svg" class="w-6 h-6"></img>
          </div>
