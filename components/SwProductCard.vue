...
<template>
  <div
    class="sw-product-card w-full group relative inline-block bg-white rounded-md transform transition duration-300 hover:scale-101"
    data-testid="product-box"
  >
    <div
      :class="[
        ' rounded-md overflow-hidden hover:opacity-75',
    ...
    >
      <client-only>
        <img
          ...
          class="h-5 w-5 fill-black c-red-500"
          data-testid="product-box-wishlist-icon-in"
        />
        <img
          v-else
          src="~/assets/icons/heart.svg"
          class="h-5 w-5 i-carbon-favorite c-black"
